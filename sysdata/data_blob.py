...
class dataBlob(object):
    ...
    def close(self):
        ...
        if self._connection_mills is not  arg_not_supplied:
            self._connection_mills.close_connection()
...
source_dict = dict(arctic="db", mongo="db", csv="db", ib="broker",mills="broker", parquet="db")
