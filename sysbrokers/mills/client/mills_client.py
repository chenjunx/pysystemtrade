...
class millsClient(object):
    """
    Client specific to mills
    ...
    def __init__(
        self, millsconnection: connectionMills, log: logger = logtoscreen("millsClient")
    ):
        ...
        # Add error handler
        # millsconnection.ib.errorEvent += self.error_handler

        self._mills_connnection = millsconnection
        self._log = log

    @property
    def mills_connection(self) -> connectionMills:
        return self._mills_connnection

    @property
    def mills(self) -> MillsGW:
        return self.mills_connection.millsGW
