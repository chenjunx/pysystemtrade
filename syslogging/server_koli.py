...
import logging_loki
from syslogging.handlers import LogRecordStreamHandler
...
def logging_server():
    ...
    try:
        ...
        parser.add_argument("-u", "--url", help="noki url?")
        ...
        with LogRecordSocketReceiver(port=args.port) as server:
            print(
                ...
                f"connections at {server}, writing to '{url}', Ctrl-C to shut down"
            )
