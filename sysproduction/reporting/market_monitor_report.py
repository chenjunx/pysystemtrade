...
MARKET_REPORT = body_text("This report lists instruments by their percentage returns, over different periods (eg 1 day, 7 days, 1 month, 3 months, 6 months, YTD and 1 year) \n"+
...
MARKET_REPORT_CUSTOM_DATES = body_text("This report lists instruments by their percentage returns, over different periods\n"+
                 "The return tables are sorted by instrument name, outright percentage return (1=1%), and vol adjusted return")
...
def _market_monitor_with_dates(
...
def _market_monitor_report_full(
