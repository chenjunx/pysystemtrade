...
def print_capital_and_get_user_input(data: dataBlob):
    ...
    if no_capital_setup:
        ...
        possible_options = {
            2: "Update capital from mills account value",
...
def get_initial_capital_values_from_user(data: dataBlob):
    ...
    if broker_account_value is arg_not_supplied:
        ...
        print("Got broker account value of %f from mills" % broker_account_value)
...
def update_capital_from_mills(data: dataBlob):
